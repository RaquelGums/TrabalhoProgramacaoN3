...
--
-- Host: 127.0.0.1
-- Generation Time: 11-Jul-2018 às 23:26
...
INSERT INTO `comentario` (`id`, `idProjeto`, `descricao`, `data`, `idUsuario`) VALUES
(50, 3, 'Teste de comentario', '2018-07-10 22:53:23', 1);
...
(3, 'TCC', 'O melhor TCC de todos os tempos.', 'C# e Java', 1, '1 semestre', 1, NULL, 'IFRS', 'O melhor programa de todos', NULL, 1);
...
(2, 'Felipe', 'felipe@gmail.com', 23456, 3, 1, '', ''),
